...
function simulate(){
  ...
  if(jellyfishTargets.count<Param.jCount){
    jellyfishTargets[jellyfishTargets.count] = new JellyfishTarget(
            Math.random(0)*2*Param.pBbox[0]-Param.pBbox[0],
            Math.random(0)*2*Param.pBbox[1]-Param.pBbox[1]-40,
            Math.random(0)*2*Param.pBbox[2]-Param.pBbox[2],
            Math.random(0)*Param.jScaleRandom+Param.jScale,
